...
- Spanish version available [here](https://github.com/) 🇪🇸.
- Portuguese version available [here](https://github.com/) 🇵🇹.
- French version available [here](https://github.com/) 🇫🇷.
 ...
 * Youtube videos require some additional work. 
  ...
  ```
 * Markdown does support Emojii :laughing: :laughing: :kissing_heart: :innocent: :red_heart: ( get some emojies [here](http://www.emoji-cheat-sheet.com/) )
